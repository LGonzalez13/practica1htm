...
function scrollRecuerda(){
  document.getElementById('Recuerda').scrollIntoView();
}
...
function scrollEstudiarLinea(){
  document.getElementById('estudiarLinea').scrollIntoView();
}

function scrollPrepaBach(){
  document.getElementById('prepaYbachi').scrollIntoView();
}

function scrollNivelSuper(){
  document.getElementById('estudiarLinea2').scrollIntoView();
}
